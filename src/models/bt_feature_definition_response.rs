...
pub struct BtFeatureDefinitionResponse {
    #[serde(rename = "featureState", skip_serializing_if = "Option::is_none")]
    pub feature_state: Option<crate::models::BtFeatureState>,
    #[serde(rename = "feature", skip_serializing_if = "Option::is_none")]
    pub feature: Option<crate::models::BtmFeature>,
...
impl BtFeatureDefinitionResponse {
    pub fn new() -> BtFeatureDefinitionResponse {
        BtFeatureDefinitionResponse {
            feature_state: None,
            feature: None,
