...
pub struct BtProjectInfo {
    ...
    pub permission_scheme: Option<crate::models::BtRbacPermissionSchemeInfo>,
    #[serde(rename = "roleMapEntries", skip_serializing_if = "Option::is_none")]
    pub role_map_entries: Option<Vec<crate::models::RoleMapEntry>>,
...
impl BtProjectInfo {
    pub fn new() -> BtProjectInfo {
        BtProjectInfo {
            permission_set: None,
            trash: None,
            permission_scheme: None,
            role_map_entries: None,
            tree_href: None,
            is_mutable: None,
            resource_type: None,
            description: None,
