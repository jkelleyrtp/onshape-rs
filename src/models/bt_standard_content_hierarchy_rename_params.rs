...
pub struct BtStandardContentHierarchyRenameParams {
    #[serde(rename = "renameTo", skip_serializing_if = "Option::is_none")]
...
impl BtStandardContentHierarchyRenameParams {
    pub fn new() -> BtStandardContentHierarchyRenameParams {
        BtStandardContentHierarchyRenameParams {
            rename_to: None,
            types: None,
