...
pub struct BtUserParams {
    ...
    #[serde(rename = "upgradeToEducationPlan", skip_serializing_if = "Option::is_none")]
    pub upgrade_to_education_plan: Option<bool>,
...
impl BtUserParams {
    pub fn new() -> BtUserParams {
        BtUserParams {
            ...
            eula_accepted: None,
            upgrade_to_education_plan: None,
            name: None,
            message: None,
            id: None,
            state: None,
