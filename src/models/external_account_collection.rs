...
pub struct ExternalAccountCollection {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ExternalAccount>>,
...
impl ExternalAccountCollection {
    pub fn new() -> ExternalAccountCollection {
